...
import { getAllCategories, deleteCategory } from '@/api/apiCategory';
              ...
              >
                ...
                <div className="mt-4 flex gap-2">
                  <button
                    ...
                    className="flex-1 px-3 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded-lg shadow transition"
                  >
                    Edit
                  </button>
                  <button
                    onClick={()=>handleDelete(cat._id)}
                    className="flex-1 px-3 py-2 bg-red-500 hover:bg-red-600 text-white rounded-lg shadow transition"
                  >
                    Delete
                  </button>
                </div>
